...
![บรรยากาศห้องทดลองอิเล็กทรอนิกส์ปี 1980 กับไมโครคอนโทรลเลอร์แพ็กเกจ DIP ซึ่งใช้แทนยุคเริ่มต้นของ Intel 8051](../../assets/images/blog/history-of-iconic-microcontrollers/08-intel-8051-1980.jpg)

*ภาพประกอบเชิงประวัติศาสตร์ของยุค MCS-51 สร้างขึ้นเพื่อเล่าเรื่อง ไม่ใช่ภาพถ่ายชิป Intel 8051 รุ่นใดรุ่นหนึ่งโดยตรง*
...
![ภาพแนวคิดสถาปัตยกรรม 8051 แสดง CPU, program ROM, data RAM, I/O ports, timers, serial port, interrupts และ clock](../../assets/images/blog/history-of-iconic-microcontrollers/09-8051-architecture.jpg)

*ภาพนี้แยกองค์ประกอบสำคัญเพื่อการอธิบาย เป็นภาพแนวคิด ไม่ใช่ผังไดจริงหรือตำแหน่งบล็อกทางกายภาพของ 8051*
