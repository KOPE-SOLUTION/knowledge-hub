...
เว็บไซต์ใช้ `docs/assets/images/kope-solution-logo-2027.png` เป็น favicon เพื่อคงอัตลักษณ์ KOPE แบบเต็มและไม่ใช้ K เดี่ยว หากเปลี่ยนไฟล์ให้แก้ `theme.favicon` ใน `mkdocs.yml` และตรวจที่ขนาด 16, 32 และ 48 px
